...
class ImageUrls1 {
  ...
  ImageUrls1({this.small, this.medium, this.large});

  ImageUrls1.fromJson(Map<String, dynamic> json) {
    small = json['small'];
    medium = json['medium'];
    large = json['large'];
  }
...
class ImageUrls2 {
  ...
  ImageUrls2({this.dark, this.light});

  ImageUrls2.fromJson(Map<String, dynamic> json) {
