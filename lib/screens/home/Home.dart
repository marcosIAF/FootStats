...
class CardScrollWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<HomeViewModel>(builder: (context, viewModel, child) {
      ...
      print(apiResponseModel.items[0].headshot.imgUrl);
                  ...
                  child: AspectRatio(
                    ...
                    child: Stack(
                      ...
                      children: <Widget>[
                        ...
                        //I want to show Image.network instead of Image.asset, but the problem is that can't able to take imgurl as apiresponse is always null.
